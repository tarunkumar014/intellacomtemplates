...
if [ -e /root/composermount/composer.json ]; then
	mkdir /root/composer && touch /root/composer/composer.json
	cat /root/composermount/composer.json > /root/composer/composer.json
